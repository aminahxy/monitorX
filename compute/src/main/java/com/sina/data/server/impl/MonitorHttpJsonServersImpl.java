 ...
 */
public class MonitorHttpJsonServersImpl implements MonitorServer {
  ...
  public MonitorHttpJsonServersImpl(String host, int port, Object userHandler) {
    this(new InetSocketAddress(host, port), userHandler);
//    this(new InetSocketAddress(port), userHandler);
  }

  public MonitorHttpJsonServersImpl(InetSocketAddress addr, Object userHandler) {
    this.addr = addr;
  ...
  public class HttpServerPipelineFactory implements ChannelPipelineFactory {
    ...
    public HttpServerPipelineFactory(Object userHandler) {
      this.handler = new HttpServerHandler(userHandler,"application/json; charset=UTF-8");
    }
